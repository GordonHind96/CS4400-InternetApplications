...
/* package hschatserver-0.1.0.0 */
#ifndef VERSION_hschatserver
#define VERSION_hschatserver "0.1.0.0"
#endif /* VERSION_hschatserver */
#ifndef MIN_VERSION_hschatserver
#define MIN_VERSION_hschatserver(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hschatserver */
...
#define CURRENT_COMPONENT_ID "hschatserver-0.1.0.0-IpJwE6Fh5zCKsDqFsKVDdd-hschatserver"
