...
/* package charserver-0.1.0.0 */
#ifndef VERSION_charserver
#define VERSION_charserver "0.1.0.0"
#endif /* VERSION_charserver */
#ifndef MIN_VERSION_charserver
#define MIN_VERSION_charserver(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_charserver */
...
#define CURRENT_COMPONENT_ID "charserver-0.1.0.0-KygRJmVjlSFCJKb5NQhQ6H-charserver"
